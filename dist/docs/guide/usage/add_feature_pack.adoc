...
NOTE: Some feature packs do not allow customization of layers or selected configuration files. Those feature packs should be installed without `--layers` or `--target-config` parameters.
