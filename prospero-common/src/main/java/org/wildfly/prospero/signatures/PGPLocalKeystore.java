...
public interface PGPLocalKeystore extends AutoCloseable {
    ...
    void importCertificate(List<PGPPublicKey> pgpPublicKeys) throws DuplicatedCertificateException, KeystoreWriteException;

    PGPPublicKey getCertificate(PGPKeyId keyId);

    Collection<PGPPublicKeyInfo> listCertificates();
}
